					...
					<div class="container">
						<div class="d-flex flex-fill flex-row">
							...
							@if($actionExportEnable)
								<div class="d-none d-md-block p-1"><button id="button_export" type="button" onclick="location.href='{{$actionExport}}';" class="btn btn-primary btn-md"><i class="pr-2 fa fa-th-list"></i>@lang('messages.Export')</button></div>
							@endif
